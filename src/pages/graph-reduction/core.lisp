; Substitution rules:
; - Leftmost strings are replaced with their outermost enclosing pair on first occurrence.
; - Rightmost strings are replaced with a ref to the enclosing pair (the step in the sequence in which the string first appears).
; - So in I, I = ((I x) x) and x = (I x),
;      in K, K = (((K x) y) x), x = (K x), and y = ((K x) y)
;      in S, S = ((((S x) y) z) ((x z) (y z))), x = (S x), y = ((S x) y), and z = (((S x) y) z)
;      in (I a), I is replaced with its ref and a = (I a), yeilding (((I x) x) (I a)). Then x is replaced with a, yeilding ((I (I a)) (I a)), which observes to a.
;      in ((K a) b), K is replaced with its ref, a = (K a), and b = ((K a) b), yeilding (((((K x) y) x) (K a)) ((K a) b)) -> (((K (K a)) ((K a) b)) (K a))
