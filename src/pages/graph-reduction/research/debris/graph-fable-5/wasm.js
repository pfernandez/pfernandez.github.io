// every program is the same machine: a four-instruction reader stapled to its record;
// programs differ only in their data segment, their focus, and their legend
